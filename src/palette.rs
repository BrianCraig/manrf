...
pub const PALETTE_ICE: Palette = Palette {
...
pub const PALETTE_DREAM: Palette = Palette {
...
pub const PALETTE_DARK_CHERRY: Palette = Palette {
...
pub const PALETTE_CARDBOARD: Palette = Palette {
